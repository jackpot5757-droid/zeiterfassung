...
const NAV = [
  ...
  { id: 'letters', label: 'Brief', icon: LetterIcon, adminOnly: true },
...
function LetterIcon() {
  return <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}><rect x="3" y="5" width="18" height="14" rx="2"/><path d="m3 7 9 6 9-6"/></svg>;
}
function PersonIcon() {
